...
def main():
    ...
    #plot_image(tr_img_arr[11])

    print("1NN with training set: ")
    predict_train = cifar_10_1NN_for(tr_img_arr[0:100],tr_img_arr,tr_label_arr)

    #print(np.sum(np.subtract(predict_train,tr_label_arr[0:1000])))
    cifar_10_eval(predict_train,tr_label_arr[0:100])

    #print("1NN with test set: ")
    #predict = cifar_10_1NN_for(test_img_arr[0:100],tr_img_arr,tr_label_arr)

    #cifar_10_eval(predict,test_label_arr[0:100])
